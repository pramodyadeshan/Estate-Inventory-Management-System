...
<div class="page-break">
    <div class="report-head">
        <h1>{{ __( session('title') ) }} - Expenditure Report</h1>
    ...
    <table>
        ...
        <tr>
            ...
            <th style="width: 10%;text-align: left;padding-left: 4px;">Created By</th>
        ...
        @if(isset($expends))
            ...
            <tr>
                <td style="text-align: center; padding: 0;">{{$expend->id}}</td>
                <td style="text-align: left; padding-left: 4px;">{{$expend->date}}</td>
                <td style="text-align: left; padding-left: 4px;">{{$expend->users->name}}</td>
                <td style="text-align: left;padding-left: 4px;">{{$expend->note}}</td>
                <td style="text-align: right;padding-right: 4px;">{{number_format($expend->price,2)}}</td>
            </tr>
            @php
                $totalSum += $expend->price;
            @endphp
            @endforeach
        @else
        <tr>
